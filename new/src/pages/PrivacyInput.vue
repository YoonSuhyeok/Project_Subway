<template>
  <q-page padding>
    <div style="margin-left: 40px; margin-right:40px;">
      ...
      <q-btn @click="sign" style="background: #128D15; margin-top:10px; width:100%" color="#128D15;" text-color="white" label="확인" :to="url"/>
    </div>
  </q-page>
</template>
...
export default class PrivacyPage extends Vue {
  ...
  sign() {
   this.$store.dispatch('moduleUser/sign', {
    ...
    const signState:boolean = this.$store.getters['moduleUser/signState'] as boolean;
