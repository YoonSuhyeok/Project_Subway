<template>
  <q-page padding>
    ...
    <div class="logo" style="margin-top:6vh;
     margin-left:12vh;
     margin-right:12vh;
     margin-bottom:5vh">
      
      <q-img style="image-rendering:optimizequality"
    ...
    <div style="margin-top:2vh; font-size:3.3vmax; text-align: center;">서브웨이 마스터와<br><strong>더 맛있고 건강한 레시피</strong></div>
    ...
    <div class="loginBox" style="margin-top:50px; margin-left:30px; margin-right:30px; border">
      ...
      <q-btn outline @click="login()" style=" margin-top:4.5vh; width:100%" color="white" text-color="black" label="Login" />
    </div>
    
    <div style="margin-top:3.5vh; text-align: center;">
      <div style="color: #636363">아이디/PW를 잊으셨나요?</div>
      <q-btn flat style="color:#2F2F2F; font-weight:bold" label="아이디/PW찾기" />
    </div>
