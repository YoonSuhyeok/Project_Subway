<template>
  <q-page padding>
    ...
    <div class="logo" style="margin-top:40px; margin-left:100px; margin-right:100px; margin-bottom:100px">
    ...
    <div style="margin-top:-50px; font-size:x-large; text-align: center;">서브웨이 마스터와<br><strong>더 맛있고 건강한 레시피</strong></div>
