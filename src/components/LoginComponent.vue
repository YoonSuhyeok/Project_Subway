<template>
    <div class="cls_totaldisplay">
        ...
        <div class="cls_input">
            <ion-input id="ID" placeholder="아이디(이메일)" />
...
export default ({
    name: 'LoginComponent', 
    components: { IonToolbar, IonTitle, IonLabel, IonInput, IonItem, IonList, IonButton, IonText, IonCheckbox, IonIcon, SimpleLogins },
    setup() {
